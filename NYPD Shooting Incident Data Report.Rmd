...
It model does a good job of predicting at the lower end and at the higher end, but it is not very good in between, indicating that we might need more variables other than the number of incidents to better predict the number of murders.
